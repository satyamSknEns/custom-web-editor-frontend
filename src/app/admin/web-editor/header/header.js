  ...
  return (
    <div className="flex items-center justify-between p-4 bg-white shadow-md h-[10vh]">
      ...
      <div className="relative w-1/3">
        ...
        >
          <span className="">{pages[selectedPage] || "Home page"}</span>
                ...
                filteredPages.map(([key, label]) => (
                  <li
                    ...
                    className={`px-4 py-2 hover:bg-gray-100 cursor-pointer ${
                      selectedPage === key ? "bg-gray-200 font-semibold" : ""
                    }`}
                  >
                    {label}
                  </li>
      ...
      <div className="flex items-center gap-5">
            ...
            <div className="w-6 h-6">
              <HiOutlineDesktopComputer
                ...
                className={`cursor-pointer ${
                  deviceMode === "desktop" ? "text-blue-500" : "text-gray-600"
                }`}
          ...
          >
            <div className="w-6 h-6">
              <MdTabletMac
                size={18}
                className={`cursor-pointer ${
                  deviceMode === "tablet" ? "text-blue-500" : "text-gray-600"
                }`}
          ...
          >
            <div className="w-6 h-6">
              <HiMiniDevicePhoneMobile
                size={20}
                className={`cursor-pointer ${
                  deviceMode === "mobile" ? "text-blue-500" : "text-gray-600"
                }`}
        ...
        <div className="flex items-center gap-1">
          ...
          >
            <button
              onClick={onSave}
              className={`px-3 w-16 h-7 pb-2 flex items-center justify-center py-1 text-sm font-semibold rounded-md ${
                undoStack.length === 0
