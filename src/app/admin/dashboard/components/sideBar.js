          ...
          {navItems.map((item) => {
            ...
            return (
              <li key={item.name} className="mb-2">
                <Link
                  href={item.href}
                  className={`flex items-center p-2.5 rounded-lg text-sm border border-gray-200 transition-colors ${ active ? "bg-orange-500 text-white border-transparent font-semibold" : "text-black hover:border-orange-500 hover:text-orange-500" }`}
                >
